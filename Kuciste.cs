...
namespace Racunala
{
    ...
    public partial class Kuciste
    {
        ...
        public int Id_Kucista { get; set; }
        public string Naziv_Kucista { get; set; }
        public string Proizvodac_Kucista { get; set; }
        public Nullable<decimal> Cijena_Kucista { get; set; }
